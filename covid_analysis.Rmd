...
##### Altough it may seem a bit overkill, I am showing all the code right here because that's the main idea of the blog. It was such an intensive Tidyverse exercise. You might pick up a couple of tricks like the use of ```split_group() + map()``` or the recently discovered package [ggtext](https://wilkelab.org/ggtext/).
...
##### I wanted to focus mainly on the most populated countries of the world because some of them are among the most affected by the virus
